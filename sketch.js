let gif;
let playing = false;
let frameInterval = 100; // 10 FPS (100ms per frame)
let currentFrame = 0;
let totalFrames = 5; // Your GIF has 5 frames
let frameTimer;

// Variables for drawing and angle calculation
let drawing = false;
let startX, startY, endX, endY;
let anglePercentage = null;
let drawnLineVisible = false; // To track if the drawn line should be visible
let lineTimer; // Timer to clear the drawn line

function preload() {
    gif = loadImage('erikgif.gif'); // Replace with your GIF file path
}
